        ...
        SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Hari ini: ${_dashboardData['hari'] ?? '-'} • Total jadwal: $totalJadwal sesi/minggu',
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text(
                        '$_activeSubject • $_activeClassName — Pertemuan ke-$_activePertemuanKe',
                        style: const TextStyle(
                          fontSize: 13,
                          color: AppColors.gray500,
                        ),
                      ...
                      const SizedBox(height: 8),
                      const Text(
                        'Siswa scan melalui aplikasi mobile',
                        style: TextStyle(
                          fontSize: 11,
                          color: AppColors.gray500,
                        ),
