                      ...
                      children: [
                        ...
                        _FieldRow(
                          children: [
                            ...
                            _ReadOnlyField(
                              label: 'ID Sistem / NIP / NISN',
                              value: _systemId.isEmpty ? '-' : _systemId,
                              hint: 'ID unik sistem terkunci',
                              mono: true,
                            ),
                          ],
                        ),
                      ...
                      children: [
                        ...
                        _FormField(
                          ...
                          child: TextFormField(
                            ...
                            decoration: _inputDecor(
                              hint:
                                  'Jl. Nama Jalan, No. Rumah, Nama Gedung/Komplek',
                            ),
                          ),
                        ),
                        const SizedBox(height: 16),
                          ...
                          children: [
                            _FormField(
                              ...
                              child: TextFormField(
                                initialValue: _rt,
                                onChanged: (v) => _rt = v,
                                decoration: _inputDecor(hint: '001'),
                                maxLength: 3,
                                keyboardType: TextInputType.number,
                                style: const TextStyle(fontFamily: 'monospace'),
                              ),
                            ...
                            _FormField(
                              ...
                              child: TextFormField(
                                initialValue: _rw,
                                onChanged: (v) => _rw = v,
                                decoration: _inputDecor(hint: '002'),
                                maxLength: 3,
                                keyboardType: TextInputType.number,
                                style: const TextStyle(fontFamily: 'monospace'),
                              ),
                        ...
                        _FormField(
                          ...
                          child: TextFormField(
                            ...
                            decoration: _inputDecor(hint: '10270'),
                            maxLength: 5,
                            keyboardType: TextInputType.number,
                            style: const TextStyle(fontFamily: 'monospace'),
                          ),
